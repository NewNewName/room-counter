...
<div class="row">
	...
	<div
		...
		<div class="container-fluid container-2">
			<form class="forms" id="timeSlotForm" action="InitTimeSlot"
				method="POST">
		...
		<div class="container-fluid container-3">
			<form class="forms" id="roomForm" method="POST" action="InitRoom">
				<h4 class="large-heading">
			...
			<div class="current-db-container">
				<div id="curRooms" class="current-db" style="height: 225px;"></div>
				<br>
